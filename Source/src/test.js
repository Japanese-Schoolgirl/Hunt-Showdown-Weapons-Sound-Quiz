...
{
	window["Categories"] = await { Rifles: {"Р1": {20: "путь", 30: "путь"}, "Р2": {40: "путь", 50: "путь"}}, Silent: {"С1": {60: "путь", 70: "путь"}, "С2": {80: "путь", 90: "путь"}}, Shotguns: {"Д1": {100: "путь", 110: "путь"}, "Д2": {120: "путь", 130: "путь"}, "Д3": {130: "путь", 140: "путь"}, "Д4": {150: "путь", 160: "путь"}, "Д5": {170: "путь", 180: "путь"}, "Д6": {190: "путь", 200: "путь"}, "Д7": {210: "путь", 220: "путь"}, "Д8": {230: "путь", 240: "путь"}, "Д9": {250: "путь", 260: "путь"}} };
